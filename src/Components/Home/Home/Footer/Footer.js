...
const Footer = () => {
  return (
    <section>
      <footer className="pt-12 pb-8 bg-white dark:bg-gray-800 xl:pt-28">
        <div className="max-w-screen-lg px-4 mx-auto text-gray-400 xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
          <ul className="flex flex-wrap justify-center pb-8 text-lg font-light">
            <li className="w-1/2 md:w-1/3 lg:w-1/3">
              <div className="text-center">
                <h2 className="mb-4 font-semibold text-red-500 uppercase dark:text-gray-200 text-md">
                  Components
                </h2>
                <ul>
          ...
          <div className="flex items-center justify-center pt-10 font-light text-center sm:pt-12">
            Credit Reserved by Newspaper.io
          </div>
        </div>
      </footer>
    </section>
