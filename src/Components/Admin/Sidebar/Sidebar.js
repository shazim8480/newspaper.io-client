          ...
          <nav className="mt-6">
            <div>
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Manage Admins</span>
              </Link>
              <Link
                className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                to="/admin/dashboard"
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Manage Teams</span>
              </Link>
              <Link
                className="flex items-center justify-start w-full p-4 my-2 font-thin text-gray-500 uppercase transition-colors duration-200 dark:text-gray-200 hover:text-blue-500"
                to="/admin/dashboard"
              ...
              >
                ...
                <span className="mx-4 text-sm font-normal">Back to Home</span>
              </Link>
            </div>
          </nav>
        </div>
